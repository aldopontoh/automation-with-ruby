...
Given 'user berada di homepage "Poin-06"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Poin-06"' do
...
And 'user pilih pelanggan baru "Poin-06"' do
...
Then 'pelanggan mendapatkan poin registrasi "Poin-06"' do
    #get text & clean
