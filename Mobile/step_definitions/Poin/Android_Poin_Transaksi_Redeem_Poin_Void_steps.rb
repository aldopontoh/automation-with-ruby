Given 'user berada di homepage "Poin-14"' do
...
And 'batalkan transaksi yang ada redeem poin "Poin-14"' do
    sleep(2)
    @app.transaksi.btn_drawer.click
...
When 'user pilih pelanggan yang transaksinya dibatalkan "Poin-14"' do
    @app.transaksi.text_produkN1.click
    @app.pelanggan.btn_pelanggan.click
    @app.pelanggan.btn_pelangganAutomation.click
...
Then 'poin pelanggan kembali bertambah "Poin-14"' do
