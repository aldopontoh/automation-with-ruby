...
Given 'user berada di homepage "Poin-05"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Poin-05"' do
...
And 'user pilih pelanggan baru "Poin-05"' do
...
When 'user pilih poin "Poin-05"' do
    @app.poin.btn_poin.click
end

Then 'system menampilkan popup poin tidak cukup "Poin-05"' do
