Given 'user berada di homepage "Poin-07"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Poin-07"' do
...
And 'user pilih pelanggan "Poin-07"' do
...
Then 'poin user bertambah dari transaksi "Poin-07"' do
    #get text & clean
