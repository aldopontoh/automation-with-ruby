Given 'user berada di homepage "Poin-15"' do
...
And 'batalkan transaksi yang ada earn poin "Poin-15"' do
    sleep(2)
    @app.transaksi.btn_drawer.click
...
When 'user pilih pelanggan yang transaksinya dibatalkan "Poin-15"' do
    @app.transaksi.text_produkN1.click
    @app.pelanggan.btn_pelanggan.click
    @app.pelanggan.btn_pelangganAutomation.click
...
Then 'poin pelanggan kembali berkurang "Poin-15"' do
