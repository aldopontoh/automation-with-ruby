Given 'user berada di homepage "Poin-03"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Poin-03"' do
...
And 'user pilih pelanggan "Poin-03"' do
...
When 'user pilih poin "Poin-03"' do
    @app.poin.btn_poin.click
end

Then 'system menampilkan popup jumlah poin pelanggan "Poin-03"' do
