Given 'user berada di homepage "Poin-02"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Poin-02"' do
...
And 'user pilih poin "Poin-02"' do
    begin
