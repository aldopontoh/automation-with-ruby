...
And 'promo tertambah otomatis "Voucher-16"' do 
    expect(@app.transaksi.text_produkZ.displayed?).to be true
end

When 'user apply voucher "Voucher-16"' do 
...
Then 'bisa apply voucher dan diskon item manual "Voucher-16"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
end