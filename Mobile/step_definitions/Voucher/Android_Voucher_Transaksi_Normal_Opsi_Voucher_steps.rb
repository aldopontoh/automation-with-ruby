...
And 'user redeem voucher "Voucher-03"' do 
...
When 'user bayar uang pas "Voucher-03"' do
    begin
...
Then 'transaksi normal voucher berhasil "Voucher-03"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
end