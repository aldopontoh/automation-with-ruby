Given 'user berada di homepage dan ada transaksi voucher sukses "Voucher-07"' do 
...
When 'user ke riwayat transaksi "Voucher-07"' do
    sleep(2)
    @app.drawer.btn_riwayattransaksi.click
end

Then 'button void disabled "Voucher-07"' do
