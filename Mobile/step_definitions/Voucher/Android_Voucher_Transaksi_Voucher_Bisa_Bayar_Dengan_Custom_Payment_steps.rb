Given 'user berada di homepage dan sudah memilih produk pelanggan dan voucher "Voucher-25"' do 
...
When 'user bayar tunai "Voucher-25"' do
...
Then 'transaksi voucher berhasil "Voucher-25"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
end