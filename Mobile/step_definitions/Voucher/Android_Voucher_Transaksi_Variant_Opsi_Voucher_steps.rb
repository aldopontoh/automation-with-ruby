...
And 'user redeem voucher "Voucher-05"' do 
...
When 'user bayar uang pas "Voucher-05"' do
    begin
...
Then 'transaksi normal voucher berhasil "Voucher-05"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
end