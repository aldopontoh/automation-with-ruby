...
And 'user redeem voucher 100 "Voucher-09"' do 
...
When 'user bayar uang pas "Voucher-09"' do
    begin
...
Then 'transaksi normal voucher berhasil "Voucher-09"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
end