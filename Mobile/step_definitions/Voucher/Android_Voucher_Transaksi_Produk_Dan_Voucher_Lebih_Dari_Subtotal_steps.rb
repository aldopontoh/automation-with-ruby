...
And 'user redeem voucher 100rb "Voucher-08"' do 
...
When 'user bayar uang pas "Voucher-08"' do
    begin
...
Then 'transaksi normal voucher berhasil "Voucher-08"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
end