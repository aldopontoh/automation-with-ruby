Given 'user berada di homepage dan sudah memilih produk pelanggan dan voucher "Voucher-31"' do 
...
When 'user batalkan voucher "Voucher-31"' do
...
Then 'voucher hilang di transaksi tersimpan "Voucher-31"' do
