...
And 'user redeem voucher 100 "Voucher-10"' do 
...
When 'user pilih split bill "Voucher-10"' do
    begin
...
Then 'transaksi voucher tidak bisa split bill "Voucher-10"' do
