Given 'user berada di homepage dan sudah memilih produk pelanggan dan voucher "Voucher-20"' do 
...
When 'user hapus semua produk di cart "Voucher-20"' do
    @app.transaksi.btn_detail_Produk.click
    @app.transaksi.btn_detail_Produk_Hapus.click
    sleep(1)
end

Then 'validasi Muncul "Voucher-20"' do
    p 'Scenario Sukses'
    sleep(2)
