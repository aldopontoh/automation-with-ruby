Given 'user berada di homepage dan sudah memilih produk pelanggan dan voucher "Voucher-28"' do 
...
Then 'transaksi voucher berhasil "Voucher-28"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
end