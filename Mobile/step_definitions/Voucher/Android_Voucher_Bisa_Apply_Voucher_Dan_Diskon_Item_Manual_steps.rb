...
And 'user tambah diskon item manual "Voucher-15"' do 
...
When 'user apply voucher "Voucher-15"' do 
...
Then 'bisa apply voucher dan diskon item manual "Voucher-15"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
end