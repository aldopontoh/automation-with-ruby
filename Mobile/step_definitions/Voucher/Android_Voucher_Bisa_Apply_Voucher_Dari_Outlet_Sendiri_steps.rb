...
When 'user redeem voucher dari outlet sendiri "Voucher-13"' do 
...
Then 'bisa apply dari outlet sendiri "Voucher-13"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
