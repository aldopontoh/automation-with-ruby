...
When 'user apply voucher all outlet "Voucher-14"' do 
...
Then 'bisa apply voucher all outlet "Voucher-14"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
