...
And 'user redeem voucher "Voucher-11"' do 
...
When 'user pilih split payment "Voucher-11"' do
    begin
...
Then 'transaksi voucher tidak bisa split payment "Voucher-11"' do
