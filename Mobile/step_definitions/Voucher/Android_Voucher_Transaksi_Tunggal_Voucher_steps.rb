...
And 'user redeem voucher "Voucher-02"' do 
...
When 'user bayar uang pas "Voucher-02"' do
    begin
...
Then 'transaksi normal voucher berhasil "Voucher-02"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
end