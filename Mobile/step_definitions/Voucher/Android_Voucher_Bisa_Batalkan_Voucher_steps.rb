Given 'user berada di homepage dan sudah memilih produk dan voucher "Voucher-18"' do 
...
When 'user batalkan voucher "Voucher-18"' do
...
Then 'bisa batalkan voucher "Voucher-18"' do
    p 'Scenario Sukses'
    sleep(2)
