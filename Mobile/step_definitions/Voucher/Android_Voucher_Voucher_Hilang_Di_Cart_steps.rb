Given 'user berada di homepage dan sudah memilih produk pelanggan dan voucher "Voucher-30"' do 
...
When 'user batalkan voucher "Voucher-30"' do
...
Then 'voucher hilang di cart "Voucher-30"' do
