...
And 'user apply voucher "Voucher-17"' do 
...
When 'user pilih cicilan "Voucher-17"' do
    @app.pembayaran.btn_cicilan.click
end

Then 'tidak bisa apply voucher jika transaksi cicilan "Voucher-17"' do
