Given 'user berada di homepage dan sudah memilih produk pelanggan dan voucher "Voucher-29"' do 
...
And 'user batalkan voucher "Voucher-29"' do
...
When 'user gunakan voucher kembali "Voucher-29"' do
    @app.poinvoucherpromo.btn_titiktiga1.click
    @app.poinvoucherpromo.btn_voucher.click
    @app.transaksi.btn_gunakanVoucher.click
end

Then 'voucher bisa digunakan kembali "Voucher-29"' do
    sleep(2)
