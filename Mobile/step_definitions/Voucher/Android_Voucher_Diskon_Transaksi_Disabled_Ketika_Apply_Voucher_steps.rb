Given 'user berada di homepage dan sudah memilih produk pelanggan dan voucher "Voucher-22"' do 
...
When 'user klik titik 3 "Voucher-22"' do
    @app.poinvoucherpromo.btn_titiktiga1.click
    sleep(1)
end

Then 'button diskon disabled "Voucher-22"' do
