...
And 'user redeem voucher "Voucher-06"' do 
...
When 'user bayar uang pas "Voucher-06"' do
    begin
...
Then 'transaksi normal voucher berhasil "Voucher-06"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Scenario Berhasil'
end