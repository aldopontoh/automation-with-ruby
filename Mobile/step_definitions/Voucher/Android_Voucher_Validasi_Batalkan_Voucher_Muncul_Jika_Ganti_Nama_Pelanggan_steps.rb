Given 'user berada di homepage dan sudah memilih produk pelanggan dan voucher "Voucher-21"' do 
...
When 'user ganti nama pelanggan "Voucher-21"' do
    @app.pelanggan.btn_pelanggan.click
    sleep(1)
end

Then 'validasi Muncul "Voucher-21"' do
    p 'Scenario Sukses'
    sleep(2)
