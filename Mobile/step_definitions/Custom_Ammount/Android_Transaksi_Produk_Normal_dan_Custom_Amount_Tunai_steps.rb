Given 'user berada di homepage "Custom Ammount"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk normal "Custom Ammount"' do
...
And 'user input custom ammount dan catatan "Custom Ammont"' do
...
When 'user bayar dengan uang tunai pas "Custom Ammount"' do
...
Then 'user sukses bayar "Custom Ammount"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
