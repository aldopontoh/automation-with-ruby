Given 'user berada di homepage "Custom Ammount Void"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk normal "Custom Ammount Void"' do
...
And 'user input custom ammount dan catatan "Custom Ammount Void"' do
...
And 'user bayar dengan uang tunai pas "Custom Ammount Void"' do
...
And 'user sukses bayar "Custom Ammount Void"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Transaksi Berhasil'
end

When 'user batalkan transaksi "Custom Ammount Void"' do
    sleep(2)
...
Then 'user sukses batalkan transaksi "Custom Ammount Void"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
