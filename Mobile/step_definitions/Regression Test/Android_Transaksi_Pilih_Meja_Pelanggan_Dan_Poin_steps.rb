Given 'user berada di homepage "Pilih Meja Pelanggan Dan Poin"' do 
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true

end

And 'user pilih pelanggan "Pilih Meja Pelanggan Dan Poin"' do
...
And 'user pilih meja "Pilih Meja Pelanggan Dan Poin"' do
...
And 'user pilih produk normal "Pilih Meja Pelanggan Dan Poin"' do
...
When 'user bayar dengan uang tunai pas "Pilih Meja Pelanggan Dan Poin"' do
...
Then 'user sukses bayar "Pilih Meja Pelanggan Dan Poin"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
