Given 'user berada di homepage "Uang Pas"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true

end

And 'user pilih produk normal "Uang Pas"' do
...
When 'user bayar dengan uang tunai pas' do
...
Then 'user sukses bayar "Uang Pas"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
