Given 'user berada di homepage "Pilih Meja Dan Pelanggan"' do 
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true

end

And 'user pilih pelanggan "Pilih Meja Dan Pelanggan"' do
...
And 'user pilih meja "Pilih Meja Dan Pelanggan"' do
...
And 'user pilih produk normal "Pilih Meja Dan Pelanggan"' do
...
When 'user bayar dengan uang tunai pas "Pilih Meja Dan Pelanggan"' do
    begin
...
Then 'user sukses bayar "Pilih Meja Dan Pelanggan"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
