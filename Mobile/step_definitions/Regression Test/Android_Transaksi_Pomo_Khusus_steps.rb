Given 'user berada di homepage "Promo Khusus"' do 
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true

end

And 'user pilih produk normal "Promo Khusus"' do
...
And 'user apply promo khusus' do 
...
And 'user bayar semua transaksi "Promo Khusus"' do
    begin
...
Then 'user sukses bayar "Promo Khusus"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
