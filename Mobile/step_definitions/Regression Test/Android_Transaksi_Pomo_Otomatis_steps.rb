Given 'user berada di homepage "Promo Otomatis"' do 
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true

end

And 'user pilih produk normal "Promo Otomatis"' do
...
And 'user apply promo otomatis' do
    $i = 0
    $num = 9
    while $i < $num  do
        @app.transaksi.text_produkN1.click
...
When 'user bayar semua transaksi "Promo Otomatis"' do
    begin
...
Then 'user sukses bayar "Promo Otomatis"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
