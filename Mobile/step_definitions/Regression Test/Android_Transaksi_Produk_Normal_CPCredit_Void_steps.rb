Given 'user berada di homepage "Custom Payment Credit Void"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true

end

And 'user pilih produk normal "Custom Payment Credit Void"' do
...
And 'user bayar dengan custom payment credit "Custom Payment Credit Void"' do
...
And 'user sukses bayar "Custom Payment Credit Void"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
...
When 'user batalkan transaksi "Custom Payment Credit Void"' do
    sleep(2)
...
Then 'user sukses batalkan transaksi "Custom Payment Credit Void"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
