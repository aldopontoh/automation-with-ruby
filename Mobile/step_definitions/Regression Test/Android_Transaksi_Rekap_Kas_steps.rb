Given 'user berada di homepage "Rekap Kas"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true

end

And 'user pilih produk normal "Rekap Kas"' do
...
And 'user bayar transaksi "Rekap Kas"' do
    begin
