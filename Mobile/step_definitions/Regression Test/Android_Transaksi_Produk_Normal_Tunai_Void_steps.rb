Given 'user berada di homepage "Uang Pas Void"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true

end

And 'user pilih produk normal "Uang Pas Void"' do
...
And 'user bayar dengan uang tunai pas "Uang Pas Void"' do
...
And 'user sukses bayar "Uang Pas Void"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
    p 'Transaksi Berhasil'

end

When 'user batalkan transaksi "Uang Pas Void"' do
    sleep(2)
...
Then 'user sukses batalkan transaksi "Uang Pas Void"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
