Given 'user berada di homepage "Normal Nops Variant Varops"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true

end

And 'user pilih produk normal nops variant varops' do
...
When 'user bayar dengan uang tunai pas "Normal Nops Variant Varops"' do
...
Then 'user sukses bayar "Normal Nops Variant Varops"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
