...
Given 'user berada di homepage "Produk dan Pelanggan"' do 
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true

end

And 'user pilih pelanggan "Produk dan Pelanggan"' do
...
And 'user pilih produk normal "Produk dan Pelanggan"' do
...
When 'user bayar dengan uang tunai pas "Produk dan Pelanggan"' do
    begin
...
Then 'user sukses bayar "Produk dan Pelanggan"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
