Given 'user berada di homepage "Custom Payment Credit"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true

end

And 'user pilih produk normal "Custom Payment Credit"' do
...
When 'user bayar dengan "Custom Payment Credit"' do
...
Then 'user sukses bayar "Custom Payment Credit"' do
    expect(@app.transaksi.text_produkN1.displayed?).to be true
