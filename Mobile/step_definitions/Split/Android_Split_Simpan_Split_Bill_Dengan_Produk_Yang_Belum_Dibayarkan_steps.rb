Given 'user berada di homepage "Split-12"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Split-12"' do
...
And 'user pilih split bill "Split-12"' do 
    begin
...
And 'user pindahkan beberapa item dan bayar "Split-12"' do 
...
When 'user simpan "Split-12"' do
    @app.split.btn_simpan_split_bill.click
    @app.split.btn_OK_simpan_split_bill.click

end

Then 'transaksi berhasil disimpan dengan produk yang belum dibayarkan "Split-12"' do
    sleep(3)
