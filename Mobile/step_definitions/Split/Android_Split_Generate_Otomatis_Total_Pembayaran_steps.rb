Given 'user berada di homepage "Split-07"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Split-07"' do
...
And 'user pilih split pembayaran "Split-07"' do
    begin
...
And 'user tambah metode pembayaran sampai 5 row "Split-07"' do 
...
When 'user hapus 1 angka di row pertama "Split-07"' do
...
Then 'system generate otomatis untuk total pembayarannya per metode pembayaran "Split-07"' do
