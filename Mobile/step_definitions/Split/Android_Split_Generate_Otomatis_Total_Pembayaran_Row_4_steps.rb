Given 'user berada di homepage "Split-08"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Split-08"' do
...
And 'user pilih split pembayaran "Split-08"' do
    begin
...
And 'user tambah metode pembayaran sampai 5 row "Split-08"' do 
...
And 'user bayar 3 metode pembayaran "Split-08"' do
...
When 'user pilih hapus "Split-08"' do
    @app.split.btn_hapus1.click    
end

Then 'system generate otomatis untuk sisa pembayarannya di row 4 "Split-08"' do
    sleep(5)
