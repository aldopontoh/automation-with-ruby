Given 'user berada di homepage "Split-11"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Split-11"' do
...
And 'user pilih split bill "Split-11"' do 
    begin
