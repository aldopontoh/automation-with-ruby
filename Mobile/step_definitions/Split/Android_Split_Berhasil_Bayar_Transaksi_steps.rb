Given 'user berada di homepage "Split-09"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Split-09"' do
...
And 'user pilih split pembayaran "Split-09"' do
    begin
...
And 'user tambah metode pembayaran sampai 5 row "Split-09"' do 
...
When 'user bayar semua metode pembayaran "Split-09"' do
...
Then 'transaksi berhasil di bayar "Split-09"' do
    sleep(2)
    begin
