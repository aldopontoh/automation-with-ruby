Given 'user berada di homepage "Split-06"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Split-06"' do
...
And 'user pilih split pembayaran "Split-06"' do
    begin
...
And 'user tambah metode pembayaran sampai 5 row "Split-06"' do 
...
When 'user pilih hapus "Split-06"' do
...
Then 'system menghapus semua row yang baru ditambahkan "Split-06"' do
