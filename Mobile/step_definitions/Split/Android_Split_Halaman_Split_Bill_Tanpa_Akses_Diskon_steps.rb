Given 'user berada di homepage "Split-10"' do
...
And 'user pilih produk "Split-10"' do
...
When 'user pilih split bill "Split-10"' do 
    begin
...
Then 'system menampilkan halaman split bill dan terdapat icon diskon "Split-10"' do
