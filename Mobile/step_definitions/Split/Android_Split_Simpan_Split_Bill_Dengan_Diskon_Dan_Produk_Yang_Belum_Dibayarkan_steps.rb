Given 'user berada di homepage "Split-13"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Split-13"' do
...
And 'user pilih split bill "Split-13"' do 
    begin
...
When 'user masukan diskon manual transaksi atau diskon khusus "Split-13"' do 
    @app.split.btn_diskon_split_bill.click
    @app.promo.btn_POCERRP.click
    @app.promo.btn_simpan.click
end

And 'user pindahkan beberapa item dan bayar "Split-13"' do 
...
And 'user simpan "Split-13"' do
    @app.split.btn_simpan_split_bill.click
    @app.split.btn_OK_simpan_split_bill.click

end

Then 'transaksi berhasil disimpan dengan diskon dan produk yang belum dibayarkan "Split-13"' do
    sleep(3)
