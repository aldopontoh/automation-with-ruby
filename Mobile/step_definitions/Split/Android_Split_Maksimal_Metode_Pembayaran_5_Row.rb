Given 'user berada di homepage "Split-04"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Split-04"' do
...
And 'user pilih split pembayaran "Split-04"' do
    begin
...
When 'user tambah metode pembayaran "Split-04"' do 
...
Then 'system menampilkan maksimal metode pembayaran 5 row "Split-04"' do
    sleep(3)
