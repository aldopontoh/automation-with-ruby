Given 'user berada di homepage "Split-05"' do
    waitFor {@app.transaksi.text_produkN1}
    expect(@app.transaksi.text_produkN1.displayed?).to be true
end

And 'user pilih produk "Split-05"' do
...
And 'user pilih split pembayaran "Split-05"' do
    begin
...
When 'user pilih opsi metode pembayaran Split-05"' do 
    @app.split.btn_pm1.click

end

Then 'system menampilkan semua custom payment termasuk tunai dan kartu "Split-05"' do
